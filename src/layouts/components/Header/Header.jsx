        ...
        <header className={styles['Header']}>
            ...
            <div className={styles['rightBox']}>
                ...
                <div className={styles['iconGroup']}>
                    ...
                    {typeof window !== 'undefined' && window.innerWidth >= 600 && (
                        <div className={styles['icons']}>
                            ...
                            <button
                                className={
                                    styles['iconBtn'] + (isAIProcessing ? ' ' + styles['spin'] : '')
                                }
                                title="AI"
                            ...
                            >
                                ...
                                >
                                    ...
                                    />
                                    <path
                                        d="M18.5 26L20.342 20.474C20.3882 20.3361 20.4766 20.2162 20.5947 20.1313C20.7128 20.0463 20.8545 20.0006 21 20.0006C21.1455 20.0006 21.2872 20.0463 21.4053 20.1313C21.5234 20.2162 21.6118 20.3361 21.658 20.474L23.5 26M26.5 20V26M19.5 24H22.5"
                                        stroke="#65686C"
                                        strokeWidth="1.5"
                                        strokeLinecap="round"
                                        strokeLinejoin="round"
                            ...
                            <button
                                className={
                                    styles['iconBtn'] +
                                    (isNewNotification ? ' ' + styles['shake'] : '')
                                }
                                title="Notifications"
                            ...
                            >
                                ...
                                >
                                    <rect width="45" height="45" rx="22.5" fill="#E5E7EB" />
                                    <path
                                        d="M23.0001 13C21.1435 13 19.3631 13.7375 18.0503 15.0503C16.7376 16.363 16.0001 18.1435 16.0001 20V23.528C16.0002 23.6831 15.9642 23.8362 15.8951 23.975L14.1781 27.408C14.0942 27.5757 14.0546 27.7621 14.063 27.9494C14.0714 28.1368 14.1276 28.3188 14.2262 28.4783C14.3248 28.6379 14.4625 28.7695 14.6263 28.8608C14.7901 28.9521 14.9745 29 15.1621 29H30.8381C31.0256 29 31.21 28.9521 31.3738 28.8608C31.5376 28.7695 31.6753 28.6379 31.7739 28.4783C31.8725 28.3188 31.9287 28.1368 31.9371 27.9494C31.9455 27.7621 31.9059 27.5757 31.8221 27.408L30.1061 23.975C30.0365 23.8362 30.0002 23.6832 30.0001 23.528V20C30.0001 18.1435 29.2626 16.363 27.9498 15.0503C26.637 13.7375 24.8566 13 23.0001 13ZM23.0001 32C22.3794 32.0003 21.7739 31.8081 21.2671 31.4499C20.7602 31.0917 20.3769 30.5852 20.1701 30H25.8301C25.6232 30.5852 25.2399 31.0917 24.733 31.4499C24.2262 31.8081 23.6207 32.0003 23.0001 32Z"
                                        fill="#65686C"
                                    />
                                    <path
                                        d="M23.0001 13C21.1435 13 19.3631 13.7375 18.0503 15.0503C16.7376 16.363 16.0001 18.1435 16.0001 20V23.528C16.0002 23.6831 15.9642 23.8362 15.8951 23.975L14.1781 27.408C14.0942 27.5757 14.0546 27.7621 14.063 27.9494C14.0714 28.1368 14.1276 28.3188 14.2262 28.4783C14.3248 28.6379 14.4625 28.7695 14.6263 28.8608C14.7901 28.9521 14.9745 29 15.1621 29H30.8381C31.0256 29 31.21 28.9521 31.3738 28.8608C31.5376 28.7695 31.6753 28.6379 31.7739 28.4783C31.8725 28.3188 31.9287 28.1368 31.9371 27.9494C31.9455 27.7621 31.9059 27.5757 31.8221 27.408L30.1061 23.975C30.0365 23.8362 30.0002 23.6832 30.0001 23.528V20C30.0001 18.1435 29.2626 16.363 27.9498 15.0503C26.637 13.7375 24.8566 13 23.0001 13ZM23.0001 32C22.3794 32.0003 21.7739 31.8081 21.2671 31.4499C20.7602 31.0917 20.3769 30.5852 20.1701 30H25.8301C25.6232 30.5852 25.2399 31.0917 24.733 31.4499C24.2262 31.8081 23.6207 32.0003 23.0001 32Z"
                ...
                >
                    <svg width="32" height="32" viewBox="0 0 48 48" fill="none">
                        <circle cx="24" cy="24" r="24" fill="#ffcd29" />
                        <path
            ...
            {fabOpen && (
                <div className={styles['fabMenu']} ref={fabMenuRef}>
                    ...
                    <button
                        className={styles['iconBtn'] + (isAIProcessing ? ' ' + styles['spin'] : '')}
                        title="AI"
                        onClick={() => {
                            setFabOpen(false)
                            navigate('/chat-ai')
